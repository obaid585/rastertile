...
class BaseTilerFactory(
    ...
    path_dependency: Callable[..., Any] = <function DatasetPathParams at 0x7f66c0cb19d0>,
    ...
    colormap_dependency: Callable[..., Union[Dict[int, Tuple[int, int, int, int]], Sequence[Tuple[Tuple[Union[float, int], Union[float, int]], Tuple[int, int, int, int]]], NoneType]] = <function ColorMapParams at 0x7f66c0e35160>,
    ...
    tms_dependency: Callable[..., morecantile.models.TileMatrixSet] = <function TMSParams at 0x7f66c37ee4c0>,
    router_prefix: str = '',
